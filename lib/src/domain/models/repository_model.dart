...
class RepositoryModel {
  ...
  factory RepositoryModel.fromMap(Map<String, dynamic> map) {
    return RepositoryModel(
      ...
      owner: map['owner'] != null ? UserModel.fromMap(map['owner'] as Map<String, dynamic>) : UserModel.fromMap({}),
      htmlUrl: map['html_url'] != null ? map['html_url'] as String : "",
      description: map['description'] != null ? map['description'] as String : "",
      fork: map['fork'] != null ? map['fork'] as bool : false,
      ...
      hasIssues: map['has_issues'] != null ? map['has_issues'] as bool : false,
      hasProjects: map['has_projects'] != null ? map['has_projects'] as bool : false,
      hasDownloads: map['has_downloads'] != null ? map['has_downloads'] as bool : false,
      hasWiki: map['has_wiki'] != null ? map['has_wiki'] as bool : false,
      hasPages: map['has_pages'] != null ? map['has_pages'] as bool : false,
      hasDiscussions: map['has_discussions'] != null ? map['has_discussions'] as bool : false,
      ...
      license: map['license'] != null ? LicenseModel.fromMap(map['license'] as Map<String, dynamic>) : LicenseModel.fromMap({}),
      allowForking: map['allow_forking'] != null ? map['allow_forking'] as bool : false,
      isTemplate: map['is_template'] != null ? map['is_template'] as bool : false,
      webCommitSignoffRequired: map['web_commit_signoff_required'] != null ? map['web_commit_signoff_required'] as bool : false,
      topics: map['topics'] != null ? List<String>.from(map['topics'].map((e) => e.toString())) : [],
      ...
      organization: map['organization'] != null ? UserModel.fromMap(map['organization'] as Map<String, dynamic>) : UserModel.fromMap({}),
